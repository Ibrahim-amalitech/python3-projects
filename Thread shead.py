...
for item in daily_transactions:
  ...
  daily_transactions_split.append(item_split)
...
for thread_color in thread_sold_split:
  if thread_color in colors:
    thread_num=color_count(thread_color)
  print("Thread Shed sold {} threads of {} thread today.".format(thread_num,thread_color))
